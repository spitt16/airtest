...
describe('AirNow Version 3.0.44 Tests', () => {
    // display baseUrl
    it('baseUrl: '+baseUrl, () => {
        // nothing
    })
    ...
    it('AIR-599 No Announcements Band title on Zero Announcements', () => {
        // "Standard Link Test". It requires 3 variables to be set. cw 2023-03-09
    ...
    it('AIR-608 2023 AQAW Announcement', () => {
        ...
        // Looks for the new announcement for AQAW 2023 cw 2023-04-19
    })
