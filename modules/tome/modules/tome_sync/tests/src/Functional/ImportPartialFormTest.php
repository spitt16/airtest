...
class ImportPartialFormTest extends BrowserTestBase {
  ...
  public function testImportPartialForm() {
    ...
    $this->assertContains($node1_name, $assert_session->elementExists('css', '[data-drupal-selector="edit-deleted"]')->getText());
    $this->assertContains($node2_name, $assert_session->elementExists('css', '[data-drupal-selector="edit-modified"]')->getText());
    $this->assertContains($node3_name, $assert_session->elementExists('css', '[data-drupal-selector="edit-added"]')->getText());
